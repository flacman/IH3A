...
class BruteForceEnv(gymnasium.Env):
    ...
    def __init__(self, user_file, password_file, delimiter=None, max_num_steps=1000, http_query=None):
        ...
        self.read_user_list(user_file, delimiter)
        if not self.passwords:
            self.read_password_list(password_file)
    ...
    def reset(self, seed=None, options=None):
        ...
        response = requests.get('http://192.168.16.146:81/restart-database')
