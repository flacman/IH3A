...
class TensorboardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        value = self.model._total_timesteps
        self.logger.record("total_timesteps", value)
        return True
...
class IH3Agent_App1:    
    ...
    register(
        ...
        kwargs={'users': users, 'passwords': passwords, 'http_query': http_query_APP1, 'agentId':1}
    )
    def __init__(self):
        manager = Manager()
    ...
    def make_env(self):
        ...
        if self.debug_mode:
            ...
            return make_vec_env('BruteForceEnv-v0', n_envs=2, seed=0,env_kwargs={'users': agent.users, 'passwords': agent.passwords, 'indexPass_map': agent.indexPass_map, 'http_query': agent.http_query_APP1, 'agentId':1})
